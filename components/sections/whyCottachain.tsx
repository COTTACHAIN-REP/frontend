...
const WhyCottachain = () => {
    ...
    return (
        ...
        >
            <div className="text-white mt-4 text-[2.5rem] font-bold"> Why Cottchain</div>
            <p className="text-center text-gray-200 leading-loose mt-5 mb-10 text-[1rem] max-w-[70%] mb-[100px]">Reputation shouldn’t be locked in platforms or prone to manipulation. COTTACHAIN makes it portable, secure, and verifiable powered by blockchain, decentralized identity, and zero-knowledge proofs. Whether you are in DeFi, DAOs, or online marketplaces, your trust score moves with you private, tamper-proof, and yours to control.</p>

            <Image src="/Frame37.svg" alt="image" height={1000} width={1000}/>



            <div className="text-white mt-4 text-[2.5rem] max-w-[70%] font-bold text-center mt-[150px]"> How Cottachain Delivers Trust Through Reputation Score</div>

            <div className="relative mt-[150px] w-full flex justify-center items-center">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-20">
                    {trustFeatures.map((item, idx) => (
                        <div key={idx} className="bg-gradient-to-r relative h-[290px] w-[290px] from-orange-500 to-blue-200 p-[1px] rounded-[10px] mx-auto">
                            <div className="h-full rounded-[10px] p-2 w-full bg-gradient-to-b from-gray-800 to-gray-700 flex justify-center items-center flex-col">
                                ...
                                <p className="text-white text-center font-bold text-[1.3rem] mt-14">{item.title}</p>
            ...
            <div className="text-white mt-4 text-[2.5rem] max-w-[70%] font-bold text-center mt-[150px]"> How to Generate Reputation Score</div>

            <div className="w-full flex flex-col items-center justify-center mt-7">
                <div className="bg-gray-200 w-full max-w-[400px] p-5 h-auto rounded-xl relative">
                    <div className="flex flex-col items-center justify-center gap-2 min-h-[220px]">
                        ...
                        <p className="font-bold flex-justify-center items-center text-[1.2rem] text-center">{steps[current].title}</p>
            ...
            <div className="text-white mt-4 text-[2.5rem] max-w-[70%] font-bold text-center mt-[150px]"> Our Infrastrcuture and Reputation System</div>

            <p className="text-center leading-loose mt-5 mb-10 text-gray-200 text-[1rem] max-w-[70%]">COTTACHAIN is built on Solana for speed, scalability, and low-cost performance. Our decentralized reputation system uses smart contracts, zero-knowledge proofs, and decentralized identity (DID) to ensure every trust score is secure, private, and tamper-proof. It’s infrastructure designed for fairness, ownership, and Web3 interoperability making your reputation portable across apps, DAOs, and marketplaces.</p>

            <div className="relative mt-[50px] w-full flex justify-center items-center">
                <div className="flex gap-14 justify-center items-center">

                    <div className="bg-gradient-to-r relative h-[290px] w-[500px] from-orange-500 to-blue-200 p-[1px] rounded-[10px] mx-auto">
                        <div className="h-full rounded-[10px] p-2 bg-gradient-to-b from-gray-800 to-gray-700 flex justify-center items-start flex-col p-7">
                            <p className="font-medium text-[1.4rem] mb-4 text-white">For contributors</p>
                    ...
                    <div className="bg-gradient-to-r relative h-[290px] w-[500px] from-orange-500 to-blue-200 p-[1px] rounded-[10px] mx-auto">
                        <div className="h-full rounded-[10px] p-2 bg-gradient-to-b from-gray-800 to-gray-700 flex justify-center items-start flex-col p-7">
                            <p className="font-medium text-[1.4rem] mb-4 text-white">For Developers</p>
                            <p className="text-white font-thin mb-5">Become part of the decentralized reputation system</p>
            ...
            <Image src="/solana.svg" alt="solana" className="mt-10 animate-bounce transition-transform mt-24 duration-800 hover:scale-105 h-[350px] w-[350px]" height={1000} width={1000} />

            <p className="text-white text-[1.3rem]">Data Sources</p>
            ...
            <div className="relative h-[300px] w-[800px] mt-20 p-[1px] rounded-[10px] mx-auto">
                <div className="h-full rounded-[15px] p-2 bg-gradient-to-b from-slate-800 to-slate-700 flex justify-center items-start flex-col p-7">
                    <p className="font-medium text-[1.5rem] mb-4 text-white">Join 10K+ users on Cottachain Protocol</p>
                    <p className="text-white font-thin text-[1.1rem] w-[65%] mb-5">Designed to turn your good deeds online into endless rewards.</p>
                   

                    <div className="flex gap-4">
                        <button className="bg-slate-800 text-white text-sm p-3 rounded-[10px] border-none">Get your reputation score</button>
