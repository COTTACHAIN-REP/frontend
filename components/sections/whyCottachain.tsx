...
const WhyCottachain = () => {
    ...
    return (
        <div className="flex flex-col items-center p-2 md:p-3 justify-center mt-10 md:mt-20 w-full">
            ...
            <div className="relative w-full my-[50px] max-w-[95vw] md:max-w-[800px] md:mt-20 p-[1px] rounded-[10px] mx-auto text-center">
                <div className="h-full rounded-[15px] p-2 bg-gradient-to-br from-[#8A7037] to-[#D97706] flex flex-col justify-center items-center p-5 md:p-7">
                    <p className="font-medium text-center text-[1.1rem] md:text-[1.5rem] mb-4 text-white">Join 200+ users on Cottachain Protocol</p>
                    <p className="text-white font-thin text-[1rem] md:text-[1.1rem] w-fit mb-5">
