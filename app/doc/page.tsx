...
const Doc = () => {
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col justify-start items-center">
            ...
            <Image src='/Group.svg' alt='chainimage' className='mt-10 transition-transform duration-200 hover:scale-105 mt-[150px] w-full h-auto md:h-[10%] md:w-[10%]' height={1000} width={1000} />
